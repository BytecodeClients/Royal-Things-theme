...
class GeneratePress_Pro_Range_Slider_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'generatepress-pro-range-slider', trailingslashit( plugin_dir_url( __FILE__ ) ) . 'js/slider-customizer.js', array( 'jquery', 'customize-base', 'jquery-ui-slider' ), GP_LIBRARY_VERSION, true );
		wp_enqueue_style( 'generatepress-pro-range-slider-css', trailingslashit( plugin_dir_url( __FILE__ ) ) . 'css/slider-customizer.css', GP_LIBRARY_VERSION );
	}
	/**
