...
class GeneratePress_Copyright_Customize_Control extends WP_Customize_Control
{
	...
	public function enqueue() {
		wp_enqueue_script( 'gp-copyright-customizer', trailingslashit( plugin_dir_url( __FILE__ ) )  . 'js/copyright-customizer.js', array( 'customize-controls' ), GP_LIBRARY_VERSION, true );
	}
